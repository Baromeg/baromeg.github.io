...
export const lightTheme = {
  ...
  toggleBorder: '#FAFAFA',
  background: '#363537',
  shadowInput: 'inset 2px 2px 5px #a5a9b6, inset -5px -5px 10px #fff',
  shadowFocus: 'inset 1px 1px 2px #BABECC, inset -1px -1px 2px #fff',
  shadowButton: '-5px -5px 20px #dfdfdf,  5px 5px 20px #BABECC',
...
export const darkTheme = {
  ...
  toggleBorder: '#6B8096',
  background: '#999',
  shadowInput: 'inset 5px 5px 5px #333d3a, inset -1px -1px 3px #cacbd1',
